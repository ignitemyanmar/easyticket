...
public class SeatbyAgentExcelUtility {
  ...
  private List<SeatReport> seatbyAgent;
  
  public SeatbyAgentExcelUtility(List<SeatReport> seatbyAgent, String filename) {
	  this.seatbyAgent = seatbyAgent;
  ...
  private void createLabel(WritableSheet sheet)
    ...
    addCaption(sheet, 2, 0, "Customer");
    addCaption(sheet, 3, 0, "Price");
    addCaption(sheet, 4, 0, "Ticket No.");
  ...
  private void createContent(WritableSheet sheet) throws WriteException,
    ...
    int i = 1;
    for(SeatReport seat: seatbyAgent){
