...
public class AdvanceBusbyDateListAdapter extends BaseAdapter {
	private List<AdvanceBusbyDate> busReports;
	private LayoutInflater mInflater;
	private Activity aty;
	
	public AdvanceBusbyDateListAdapter(Activity aty,List<AdvanceBusbyDate> operdate) {
		super();
