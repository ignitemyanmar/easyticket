...
public class SeatbyTripExcelUtility {
  ...
  private List<SeatsbyTrip> seatbyTrip;
  
  public SeatbyTripExcelUtility(List<SeatsbyTrip> seatbyTrip, String filename) {
	  this.seatbyTrip = seatbyTrip;
  ...
  private void createContent(WritableSheet sheet) throws WriteException,
    ...
    int i = 1;
    for(SeatsbyTrip seat: seatbyTrip){
    	addLabel(sheet, 0, i, seat.getSeat_no());
    	addLabel(sheet, 1, i, seat.getCustomer_name());
    	addLabel(sheet, 2, i, seat.getAgent_name());
