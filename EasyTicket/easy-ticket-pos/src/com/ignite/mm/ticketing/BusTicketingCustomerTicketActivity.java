...
public class BusTicketingCustomerTicketActivity extends BaseSherlockActivity {
	...
	private OnClickListener clickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			if(v == btn_delete){
				SKConnectionDetector skDetector = SKConnectionDetector.getInstance(BusTicketingCustomerTicketActivity.this);
		...
		if(chk_remove_all.isChecked()){
			NetworkEngine.getInstance().deleteAllOrder(accessToken, creditOrder.getId().toString(), new Callback<JSONObject>() {
				...
				public void failure(RetrofitError arg0) {
					// TODO Auto-generated method stub
					dialog.dismiss();
					SKToastMessage.showMessage(BusTicketingCustomerTicketActivity.this, "Can't Delete Record.", SKToastMessage.ERROR);
				}

				public void success(JSONObject arg0, Response arg1) {
					// TODO Auto-generated method stub
					dialog.dismiss();
					SKToastMessage.showMessage(BusTicketingCustomerTicketActivity.this, "Successfully deleted.", SKToastMessage.SUCCESS);
					finish();
				}
			});
		}else{
