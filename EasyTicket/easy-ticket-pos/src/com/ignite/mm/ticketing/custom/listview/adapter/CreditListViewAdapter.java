...
public class CreditListViewAdapter extends BaseAdapter {
	...
	public CreditListViewAdapter(Activity aty, List<CreditOrder> _list){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
        	...
        	holder.name = (TextView) convertView.findViewById(R.id.txt_customer_name);
		...
		holder.name.setText(getItem(position).getCustomer().toString());
		holder.phone.setText("Phone: "+getItem(position).getPhone().toString());
