						         ...
						         <div class="portlet-body form">
						            ...
						            <form class="form-horizontal" action = "/advertisement" method= "post" enctype="multipart/form-data">
						                <div class="control-group">
						                  <label class="control-label">Detail Link</label>
						                  <div class="controls">
						                ...
						                <div class="control-group">
							                ...
							                <div class="span10 responsive">
	                                           ...
	                                           <span>Image size for maximun width is and height is (960px X 455px) and minimun width and height is (200px X 200px).</span>
                                        	</div>
                                        </div>
