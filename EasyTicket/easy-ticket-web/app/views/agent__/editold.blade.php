                              ...
                              <div class="row-fluid">
                                 <div class="span6">
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <select name="agentgroup" id='agentgroup' class="m-wrap span12">
                                             @foreach($response['agentgroup'] as $objagentgroup)
                                                <option value="{{$objagentgroup->id}}" @if( $objagentgroup['id']==$response['agent']['agentgroup_id']) selected @endif>{{$objagentgroup['name']}}</option>
                                             @endforeach   
                                          </select>    
                                       </div>
                                    </div>
