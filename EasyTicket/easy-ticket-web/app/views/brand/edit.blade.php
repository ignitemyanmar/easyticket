						   ...
						   <div class="span12">
						      ...
						      <div class="portlet box blue">
						         <div class="portlet-title">
						            <h4><i class="icon-reorder"></i>Update Brand</h4>
						         </div>
						         <div class="portlet-body form">
						            <!-- BEGIN FORM-->
						            <form class="form-horizontal" action = "/brand/update/{{$response->id}}" method= "post" enctype="multipart/form-data">
                                                   ...
                                                   <ul>
                                                      <div class="gallery_container1">
                                                      	<li class="gallery_photo right">
															<img src="../../brandphoto/php/files/thumbnail/{{ $response['image'] }}"></img>
