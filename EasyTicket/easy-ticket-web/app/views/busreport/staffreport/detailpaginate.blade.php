...
<style type="text/css">
   ...
   tbody td, thead th{border-right: 1px solid #EEEEEE;}
                           ...
                           <div id="contents">
                                  ...
                                  @if($response)
                                    <tbody class="table-bordered">
                                      ...
                                      @foreach($response as $key=>$result)
                                        @if($group != $result['seller_name'])
                                          <tr class="group">
                                            <th colspan="14">
                                              {{$result['seller_name']}} အေရာင္းစားရင္းမ်ား
                                            </th>
                                          </tr>
                                        @endif
                                        <?php $group =$result['seller_name']; ?>
                                        <tr>
                                           <!-- <td></td> -->
                              ...
                              @if($response)
                                <div class="pagination pull-right">
                                  {{$response->appends(array('access_token' => $myApp->v_access_token))->links();}}
                                </div>
                              @endif
                           </div>
                        </div>
