						   ...
						   <div class="span12">
						      ...
						      <div class="portlet box blue">
						         ...
						         <div class="portlet-body form">
						            <!-- BEGIN FORM-->
						            <form class="form-horizontal" action = "/category/update/{{$response->id}}" method= "post">
			                                 ...
			                                 <select class="span6 chosen" data-placeholder="Choose a Menu" tabindex="1" name="menu">
			                                    @if($response['menu'])
			                                    	@foreach($response['menu'] as $arr_menu)
			                                    		...
			                                    		<option value="{{$arr_menu['id']}}" 
				                                    		@if($response->menu_id == $arr_menu['id'])
				                                    			Selected
				                                    		@else 
				                                    		@endif
			                                    		>{{$arr_menu['name'] ." ( ". $arr_menu['name_mm'] ." )" }}</option>
			                                    	@endforeach
			                                    @endif
			                                 </select>
			                              </div>
                                                   ...
                                                   <ul>
                                                      <div class="gallery_container1">
                                                      	<li class="gallery_photo right">
															<img src="../../categoryphoto/php/files/thumbnail/{{ $response['image'] }}"></img>
						                ...
						                <div class="form-actions">
						                  ...
						                  <a href="/category"><button type="button" class="btn">Cancel</button></a>
						                </div>
						            </form>
						            <!-- END FORM-->           
						         </div>
