               ...
               <div class="row-fluid">
                  <div class="span12">
                     ...
                     <ul class="breadcrumb">
                        ...
                        <li><a href="#">Edit CommissionType</a></li>
                     </ul>
                  </div>
               </div>
            <!-- END PAGE HEADER-->
            ...
            <!-- BEGIN PAGE CONTENT-->
               <div class="row-fluid">
                  <div class="responsive span8" data-tablet="span8" data-desktop="span8">
                     <form id="addnew-form" class="horizontal-form" action = "/updatecommissiontype/{{$commissiontype->id}}" method= "post" enctype="multipart/form-data">    
                              ...
                              <div class="row-fluid">
                                 <div class="span6">
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input name="name" class="m-wrap span12" required="required" value="{{$commissiontype['name']}}" type="text">
                                       </div>
                                    </div>
                                 </div>
                              </div>
