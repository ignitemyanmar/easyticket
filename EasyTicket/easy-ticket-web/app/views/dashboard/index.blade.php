			...
			<div class="container-fluid">
				...
				<div id="dashboard">
					...
					<div class="row-fluid">
						...
						<div class="responsive span6" data-tablet="span6" data-desktop="span3">
							<div class="dashboard-stat purple">
								...
								<div class="details">
									...
									<div class="desc">									
										Let Chat with Customer
									</div>
								</div>
								<a class="more" target="blank" href="https://mylivechat.com/webconsole/">
								Go To Chat <i class="m-icon-swapright m-icon-white"></i>
								</a>						
							</div>
						</div>
						<div class="responsive span6" data-tablet="span6" data-desktop="span3">
						...
						<div class="responsive span6 fix-offset" data-tablet="span6" data-desktop="span3">
