        ...
        <div class="content">
          ...
          <form class="form-vertical register-form" action="/user-register" method="post">
            ...
            <div class="form-actions">
              ...
              <input type="hidden" value="seller" name="seller" id="seller">
              <div class="control-group">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <div class="input-icon left">
                    <i class="icon-user"></i>
                    <input class="m-wrap placeholder-no-fix" type="text" placeholder="Phone" name="phone" id='phone'/>
                  </div>
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <div class="input-icon left">
                    <i class="icon-user"></i>
                    <input class="m-wrap placeholder-no-fix" type="text" placeholder="Address" name="address" id='address'/>
                  </div>
                </div>
              </div>
