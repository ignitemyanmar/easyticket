                                             ...
                                             <div class="span12">
                                                  <div class="span2 push-left">&nbsp;</div>
                                                   <div class="span4 push-left">
                                                      <!-- <div class="row-fluid push-left"> -->
                                                         <label>Shop</label>
                                                         <input type="text" class="m-wrap span8 price" placeholder="Shop Name"  name="compareshop[]" value="" />
                                                      <!-- </div> -->
                                                   </div>
                                                   <div class="span4 push-left">
                                                      <!-- <div class="row-fluid push-left"> -->
                                                         <label>Price</label>
                                                         <input type="text" class="m-wrap span6 price" placeholder="Price"  name="compareprice[]" value="" onKeyPress="return isNumberKey(event);" />
                                                      <!-- </div> -->
                                                   </div>
                                                   <div class="span2">
                                                      <div class="row-fluid push-left"><br>
                                          ...
                                          <div class="row-fluid items">
                                             ...
                                             <div class="span10">
                                                <!-- <div class="control-group"> -->
                                                  ...
                                                  <div class="span2 push-left">
                                                      <label>Price</label>
                                                      <input type="text" class="m-wrap span12 price" placeholder="Price"  name="price[]" value="" onKeyPress="return isNumberKey(event);" />
                                                   </div>
                                                   <div class="span2 push-left">
                                                      <label>Old Price</label>
                                                      <input type="text" class="m-wrap span12 price" placeholder="OldPrice"  name="oldprice[]" value="" onKeyPress="return isNumberKey(event);" />
                                                   </div>
                                                   <div class="span1 push-left">
                                                      <label>&nbsp;</label>
