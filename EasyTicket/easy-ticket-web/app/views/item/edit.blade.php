                                 ...
                                 <div class="tab-content">
                                    <div class="tab-pane active" id="tab1">
                                       ...
                                       <div id="quantityrangeinfo">
                                          @if(count($response['pricebyqtyranges'])>0)
                                             @foreach($response['pricebyqtyranges'] as $qtyrange)
                                                        ...
                                                        <div class="span4 push-left">
                                                                  ...
                                                                  <select class="span8 qtyrange" data-placeholder="Choose a Quantity Range" tabindex="3" name="quantityrange[]">
                                                                     @if(count($comboarray['quantityrange'])>0)
                                                                        ...
                                                                        @foreach($comboarray['quantityrange'] as $quantityrange)
                                                                           <option value="{{$quantityrange['id']}}" @if($quantityrange['id']==$qtyrange['priceqtyrange_id']) selected @else @endif>{{$quantityrange['startqty'].'-'. $quantityrange['endqty']}}</option>
                                                                           <?php $i++; ?>
                                                                        @endforeach
                                                                     @else
                                                                     @endif
                                                         ...
                                                         <div class="span4 push-left">
                                                            <!-- <div class="row-fluid push-left"> -->
                                                               <label>Price</label>
                                                               <input type="text" class="m-wrap span6 price" placeholder="Price"  name="pricebyqty[]" value="{{ $qtyrange->price}}" onKeyPress="return isNumberKey(event);" />
                                                            <!-- </div> -->
                                                         </div>
                                                         <div class="span2">
                                                               ...
                                                               <select name="size[]" class="m-wrap span12 size">
                                                                  @if(count($comboarray['size'])>0)
                                                                     ...
                                                                     @foreach($comboarray['size'] as $size)
                                                                        <option value="{{$size['id']}}" @if($dtrow->size_id==$size->id) selected @endif>{{$size['name']}}</option>
                                                                        <?php $i++; ?>
                                                                     @endforeach
                                                                  @else
                                                                     <option value=""></option>
                                       ...
                                       <div class="control-group">
                                          ...
                                          <div class="controls">
                                             <input type="text" name="qty_per_control" value="{{$response['qty_per_control']}}">
                                          </div>
                                       </div>
                                       <div class="clear-fix">&nbsp;</div>
                                       ...
                                       <div class="control-group">
                                          ...
                                          <div class="controls">
                                             <textarea class="span12 ckeditor m-wrap" rows="6" name="service">{{$response->service}}</textarea>
                                          </div>
                                       </div>
