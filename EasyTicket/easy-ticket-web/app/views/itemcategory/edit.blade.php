				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="/subcategorylist">Item Categoy List</a></li>
						</ul>
						   ...
						   <div class="span12">
						      ...
						      <div class="portlet box blue">
						         <div class="portlet-title">
						            <h4><i class="icon-reorder"></i>Update Item Categoy</h4>
						         </div>
						         <div class="portlet-body form">
						            <!-- BEGIN FORM-->
						            <form class="form-horizontal" action = "/itemcategory/update/{{$response->id}}" method= "post" enctype="multipart/form-data">
			                                 ...
			                                 <select class="span6 chosen" data-placeholder="Choose a Category" tabindex="1" name="menu" id="menu">
			                                    @if($response['menu'])
			                                    	@foreach($response['menu'] as $arr_menu)
			                                    		<option value="{{$arr_menu->id}}"  @if($arr_menu->id==$response->menu_id) selected @endif>{{$arr_menu->name ." ( ". $arr_menu->name_mm ." )" }}</option>
			                                    	@endforeach
			                                    @endif
			                                 </select>
			                              </div>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                             ...
                                             <div id="subcategoryframe">
                                                <select class="span6 chosen" data-placeholder="Choose a Category" tabindex="3" name="subcategory_id" id="subcategory">
                                                	@foreach($response['subcategory'] as $row)
                                                		<option value="{{$row->id}}" @if($row->id==$response->category_id) selected @endif>{{$row->name.' ( '.$row->name_mm.' )'}}</option>
                                                	@endforeach
                                                </select>
                                                <input type="hidden" name="hdsubcategoryid" value="0">
                                             </div>
                                          </div>
                                        </div>
						               
						                <div class="control-group">
						                  <label class="control-label">Item Categoy</label>
						                  <div class="controls">
						                ...
						                <div class="control-group">
						                  <label class="control-label">Item Categoy (Myanmar)</label>
						                  <div class="controls">
                                                   ...
                                                   <ul>
                                                      <div class="gallery_container1">
                                                      	<li class="gallery_photo right">
															<img src="../../itemcategoryphoto/php/files/thumbnail/{{ $response['image'] }}"></img>
						                ...
						                <div class="form-actions">
						                  ...
						                  <a href="/itemcategory"><button type="button" class="btn">Cancel</button></a>
						                </div>
						            </form>
						            <!-- END FORM-->           
						         </div>
