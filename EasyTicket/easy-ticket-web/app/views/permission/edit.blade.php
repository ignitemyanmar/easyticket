            ...
            <!-- BEGIN PAGE CONTENT-->
               <div class="row-fluid">
                  <div class="responsive span12" data-tablet="span12" data-desktop="span12">
                     ...
                     <form id="addnew-form" class="horizontal-form" action = "/permission-update/{{$role}}" method= "post" enctype="">    
                        <div class="portlet box light-grey">
                           ...
                           <div class="portlet-body">
                              <div class="row-fluid">
                                 <div class="span6">
                                    <div class="control-group">
                                       <label class="control-label" for="name"><b>Role</b></label>
                                       <div class="controls">
                                          <select class="chosen span12" name="role">
                                             @foreach($response['role'] as $key=>$row)
                                                <option value="{{$key}}" @if($permissions[0]['role']==$key) selected @endif>{{$row}}</option>
                                             @endforeach
                                          </select>
                                       </div>
                                    </div>
                              ...
                              <div class="row-fluid">
                                 <div class="span12">
                                    <label class="control-label"><b>Permissions</b></label><br>
                                    <div class="control-group">
                                       <div class="controls">
                                          @foreach($response['menu'] as $key=>$permission)
                                             ...
                                             <div class="span6">
                                                ...
                                                <div id="uniform-undefined" class="checker"><span><input style="opacity: 0;" value="{{$permission}}" type="checkbox" name="permission[]" {{$checked}}></span></div> {{$permission}}
                                                </label>
                                             </div>
