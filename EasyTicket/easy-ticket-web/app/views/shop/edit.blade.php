						   ...
						   <div class="span12">
						      ...
						      <div class="portlet box blue">
						         <div class="portlet-title">
						            <h4><i class="icon-reorder"></i>Update Shop</h4>
						         </div>
						         <div class="portlet-body form">
						            <!-- BEGIN FORM-->
						            <form class="form-horizontal" action = "/shop/update/{{$response->id}}" method= "post" enctype="multipart/form-data">
						                ...
						                <div class="control-group">
						                  ...
						                  <div class="controls">
						                     <input type="text" class="span6 m-wrap" name="phone" value="{{$response->phone}}" required/>
						                  </div>
						                </div>
						                ...
						                <div class="control-group">
						                  ...
						                  <div class="controls">
						                     <input type="text" class="span6 m-wrap" name="address" value="{{$response->address}}"/>
						                  </div>
						                </div>
                                                   ...
                                                   <ul>
                                                      <div class="gallery_container1">
                                                      	<li class="gallery_photo right">
															<img src="../../shopphoto/php/files/thumbnail/{{ $response['image'] }}"></img>
