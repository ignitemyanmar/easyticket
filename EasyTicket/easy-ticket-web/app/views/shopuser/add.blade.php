            ...
            <!-- BEGIN PAGE CONTENT-->
               <div class="row-fluid">
                  <div class="responsive span8" data-tablet="span8" data-desktop="span8">
                     <form id="addnew-form" class="horizontal-form" action = "/shopuser" method= "post" enctype="multipart/form-data">    
                              ...
                              <div class="row-fluid">
                                 <div class="span6">
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input name="name" class="m-wrap span12" required="required" type="text">
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="row-fluid">
                                 <div class="span6">
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input name="email" class="m-wrap span12" required="required" type="text">
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="row-fluid">
                                 <div class="span6">
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input name="address" class="m-wrap span12" required="required" type="text">
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="row-fluid">
                                 <div class="span6">
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input name="phone" class="m-wrap span12" required="required" type="text">
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="row-fluid">
                                 <div class="span6">
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input name="permit_count" class="m-wrap span12" required="required" type="text">
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <select name="expired_at" required="required">
                                             @for($i=1; $i <= 10; $i++)
                                                <option value="{{$i}}">{{$i}} @if($i<= 1) - Year @else - Years @endif</option>
                                             @endfor
                                          </select>
                                       </div>
                                    </div>
