						   ...
						   <div class="span12">
						      ...
						      <div class="portlet box blue">
						         <div class="portlet-title">
						            <h4><i class="icon-reorder"></i>Create SubCategory</h4>
						         </div>
						            ...
						            <form class="form-horizontal" action = "/subcategory" method= "post">
						               ...
						               <!--  <div class="control-group">
						                ...
						                <div class="control-group">
						                  ...
						                  <div class="controls">
						                  	<?php $listsorting=SubCategory::where('priority','!=',0)->groupBy('priority')->lists('priority'); ?>
						                  	<select name="priority" id="sorting" class="chosen span6">
						                  		@for($i=0; $i <= 100; $i++)
						                  			...
						                  			@endforeach
						                  			@if($same==false)
						                  				<option @if($i==0) value='1000' @else value="{{$i}}" @endif>@if($i==0) Normal @else {{$i}} @endif</option>
						                  			@endif
						                  		@endfor
						                  	</select>
						                  </div>
