            ...
            <!-- BEGIN PAGE CONTENT-->
               <div class="row-fluid">
                  <div class="responsive span12" data-tablet="span12" data-desktop="span12">
                     <form id="tripcreate" class="form-horizontal" action = "/trip/extend/{{$response->id}}" method= "post">    
                              ...
                              <div class="row-fluid">
                                 <div class="span8">
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input  name="extend_price" class="m-wrap span12" placeholder="" type="text" required>
                                       </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input  name="extend_foreign_price" class="m-wrap span12" placeholder="" type="text" required>
                                       </div>
                                    </div>
