        ...
        $('#form_wizard_1').bootstrapWizard({
            ...
            onNext: function (tab, navigation, index) {
                ...
                for(var j=0; j<totalimagecount; j++){
                    ...
                    imagediv +='<div class="controls">'+
                                    '<div class="gallery-input bg-transparent">'+
                                        '<ul>'+
                                            '<div class="'+classnamefordiv+'">'+
                                            '</div>'+
                                            '<div class="script"></div>'+
                                            '<div class="'+uploadthumbdiv+'">'+
                                               '<span>+</span>'+
                                               '<input type="file" id="gallery_upload'+obj_colors[j].color+'"'+
                                               'onclick="return uploadimg(this)" data-url="../itemphoto/php/index.php">'+
                                            '</div>'+
                                        '</ul>'+
                                    '</div>'+
                               '</div>';
