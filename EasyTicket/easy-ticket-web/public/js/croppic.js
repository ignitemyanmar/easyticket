			...
			that.form.find('input[type="file"]').change(function(){
				...
				$.ajax({
					...
					if(response.status=='success'){
						...
						that.obj.append('<img src="'+that.options.outputUrl+response.url+'">');
			...
			$.ajax({
                ...
                type: 'POST'
					...
					if(response.status=='success'){
						...
						that.obj.append('<img class="croppedImg" src="'+that.options.outputUrl+response.url+'">');
						
						that.obj.append('<input type="hidden" name="file_name" value="'+response.file_name+'">');
